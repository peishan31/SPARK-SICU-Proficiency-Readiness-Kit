...
const WITH_BOOKMARKS_USER_ID = "115424434485045779771"
...
const NO_BOOKMARKS_USER_ID = "115374010104534257674"
...
describe("Testing Add and Remove Bookmark to User By UserId route", () => {
    ...
    it("should return the bookmark id for the new bookmark", async () => {
        const data = {
            "subchapterId": "641713712206cdb94e8b307d",
            "chapterId": "6415b83df79d4564b394fbea"
        }
