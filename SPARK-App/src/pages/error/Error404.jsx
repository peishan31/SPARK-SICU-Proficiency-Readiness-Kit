    ...
    return (
        ...
        <Grid container mt={5} spacing={3} alignItems="center">
            <Grid item xs={12} sm={7}>
                <Typography sx={{ typography: { sm: 'h2', xs: 'h4' } }} align="center" color='#41ADA4' my={2} >404 - Not Found</Typography>
                <Typography my={2} sx={{ typography: { sm: 'h6'} }} align="center" >We can't find the page you're looking for.</Typography>
